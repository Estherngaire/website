function Services(){
    ...
    return(
        <div className="flex flex-col gap-4 bg-pink-100 p-4 text-slate-700 flex-grow">
            <h1 className="font-bold text-center">Services i offer</h1>
            ...
            <div>
                <h2 className="text-xl font-bold text-center text-slate-900">Web Services</h2>
                <ul className="flex flex-col gap-3 p-3 list-inside list-disc">
                    {WebService.map((web)=>
                    <li key={web}>{web}</li>)}
                </ul>
            </div>
            <div>
                <h2 className="text-xl font-bold text-center text-slate-900 ">Design Services</h2>
                <ul className="flex flex-col gap-3 p-3 list-inside list-disc">
