function About(){
    ...
    return(
            <div className="flex flex-col md:flex-row gap-6 p-6 bg-pink-100 text-slate-700 flex-grow">
                <article className="md:w-2/3">
                    ...
                    <div className="flex flex-col md:flex-row  p-3">
                        <div className="p-3">
                        <h2 className="font-bold text-slate-800">WebDevelopment</h2>
                    ...
                    <div className="p-3">
                        <h2 className="font-bold text-slate-800">Graphic Design</h2>
                ...
                <aside className="flex flex-col md:w-1/3 border border-collapse border-gray-400 p-4 rounded-lg bg-slate-200 h-fit">
                    <h1 className="font-bold text-center text-slate-900">Skills</h1>
                <div className="flex flex-row gap-8 justify-center">
                    <div>
                        <h2 className="font-bold text-slate-800">Web Development</h2>
                   ...
                   <div>
                       <h2 className="font-bold text-slate-800">Graphics</h2>
                     <ul className="list-inside list-disc">
            ...
            <section className="flex flex-col justify-center p-8">
                <h1 className="font-bold text-slate-900">Currently Learning</h1>
                <ul className="list-inside list-disc ">
                    {Learning.map((learn)=>
